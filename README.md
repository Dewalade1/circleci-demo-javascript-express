...
This project was built from a MERN Starter kit (original URLs broken) by Udacity. Discussions still [active here](https://hashnode.com/n/mern). MERN is Mongo, Express, React and NodeJS. I am using this to test circleci webhooks
